...
(function () {
  ...
  let state = { modal: null, palette: false, paletteSel: 0, rxItems: [] };
    ...
    <header class="site-nav">
      <div class="inner">
        ...
        <nav class="links">
          ...
          ${user
            ? `<a class="btn sm" href="#/app/dashboard">Open portal · ${esc(user.name.split(" ")[0])}</a>`
            : `<a class="btn sm" href="#/login">Staff portal</a>`}
        </nav>
      </div>
    </header>
        ...
        <div class="panel">
          ...
          <div class="panel-body">
            ...
            <div class="row" style="margin-top:16px;">
              ...
              <a class="btn subtle" href="pharmacy-stock-log.html">Standalone stock log</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="stack">
      ...
      <div class="grid-side">
        ...
        <div class="stack">
          ...
          <div class="panel">
            <header><h3>Billing summary</h3></header>
            <div class="panel-body">
              <div class="stack" style="gap:10px;">
                <div class="row" style="justify-content:space-between;">
                  <span style="color:var(--ink-soft); font-size:13.5px;">Card fee</span>
                  <span class="mono" style="font-weight:600;">${money(spend.card)}</span>
                </div>
                <div class="row" style="justify-content:space-between;">
                  <span style="color:var(--ink-soft); font-size:13.5px;">Drugs dispensed</span>
                  <span class="mono" style="font-weight:600;">${money(spend.drugs)}</span>
                </div>
                <div class="row" style="justify-content:space-between; border-top:1px solid var(--line); padding-top:10px;">
                  ...
                  <span class="mono" style="font-weight:800; font-size:17px;">${money(spend.total)}</span>
                </div>
              </div>
              <button class="btn subtle sm" data-action="print-receipt" data-id="${p.id}" style="margin-top:14px; width:100%;">
                ${icon("print", 15)} Print statement
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="form-grid">
            ...
            <div class="field"><label for="np_fee">Card fee (₦)</label>
              <input id="np_fee" name="cardFee" type="number" min="0" step="50" value="2000" required>
        ...
        <div class="modal-body">
          <div class="form-grid">
            ...
            <div class="field"><label for="ad_price">Unit price (₦)</label>
              <input id="ad_price" name="unitPrice" type="number" min="0" step="10" required></div>
